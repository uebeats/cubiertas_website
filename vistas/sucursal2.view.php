  ...
  <div class="main-content">
    ...
    <section class="divider">
      <div class="container">
        <div class="row pt-30">
          <div class="col-md-6">
            <h3 class="line-bottom mt-0 mb-30">Sucursal: Av. Estero La Posada 3551, Coronel<br>Región del Bío Bío.</h3>
          ...
          <div class="col-md-6">
            ...
            <div class="icon-box media mb-15"> <a class="media-left pull-left flip mr-15" href="#"> <i class="pe-7s-mail text-theme-colored"></i></a>
              <div class="media-body">
                ...
                <p><a href="mailto:aortiz@cubiertasnaciones.cl">aortiz@cubiertasnaciones.cl</a></p>
              </div>
            </div>
